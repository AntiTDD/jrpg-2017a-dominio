 ...
 * clase es la de casta Asesino.<br>
...
public class Asesino extends Casta {
	 ...
	 *
	 * @param prob_crit
	 *            Double que indica la probabilidad de meter un critico que
	 *            tiene este objeto.
	 *
	 * @param evasion
	 *            Double que indica la evasion que tiene este objeto.
	 * @param daño_crit
	 *            Double que indica el da�o critico que tiene este objeto.
	 */
	...
	/**
	 * El presente metodo devuelve un booleano
	 *  indicando si este objeto de casta
	 * Asesino le mete, o no, un golpe critico al atacado. Puede ser atacado
	 * tanto un Personaje como un NPC, por esto es un objeto Peleable.
	 *
	 * @param caster
	 *            Objeto Personaje el cual ataca.
	 * @param atacado
	 *            Objeto Peleable el cual es el atacado.
	...
	/**
	 * El presente metodo devuelve un booleano
	 *  indicando si este objeto puede
	 * incrementar, o no, la evasion del objeto Peleable que es el objeto a
	 * quien se le intenta subir la evasion. Esta evasion puede llegar a s�
	 * mismo, a cualquier objeto Personaje como a un NPC.
	 *
	 * @param caster
	 *            Objeto Personaje el cual intenta subir la evasion.
	 * @param atacado
	 *            Objeto Peleable al cual se le intenta subir la evasion.
	...
	public boolean habilidad2(Personaje caster, Peleable atacado) {
		if (caster.getEnergia() > energiaMinima) {
			...
			if (this.getProbabilidadEvitarDaño()
					+ plusEvitarCritico < plusEvitarDaño) {
				this.probabilidadEvitarDaño
				+= plusEvitarCritico;
			} else {
	...
	/**
	 * El presente metodo devuelve un booleano
	 * indicando si este objeto puede, o
	 * no, robar al objeto atacado.
	 *
	 * @param caster
	 *            Objeto de tipo Personaje el cual es quien ataca.
	 * @param atacado
	 *            Objeto de tipo Peleable el cual es el atacado.
	 * @return Booleano que indica si
	 *  este objeto pudo realizar el robo, o no.
	 */
