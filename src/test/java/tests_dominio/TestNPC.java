...
public class TestNPC {
	...
	@Test
	public void queAlInstanciarUnNpc…steSeaDeDificultad1()
	{
	...
	@Test
	public void queElNPCConAtaque584AtaqueAOrcoConDefensa10YSalud110()  // PREGUNTAR: Como testear la primer rama del if en el metodo "atacar" del NPC? Por como esta escrito ese if, jamas se va a entrar por esa rama y por eso no puedo testearla. //
	{
		NonPlayableCharacter npc=new NonPlayableCharacter("Elrond",95,1);
